# SharePoint Framework Docker images for pnp/spfx generator

This readme is stolen from: [https://github.com/waldekmastykarz/docker-spfx](https://github.com/waldekmastykarz/docker-spfx) and is just to try docker and @pnp/spfx
...
```sh
cd [your project]
docker run -it --rm --name ${PWD##*/} -v $PWD:/usr/app/spfx -p 5432:5432 -p 4321:4321 -p 35729:35729 stfbauer/pnpspfx
```
...
```PowerShell
cd [your project]
docker run -it --rm --name spfx-helloworld -v ${PWD}:/usr/app/spfx -p 5432:5432 -p 4321:4321 -p 35729:35729 stfbauer/pnpspfx
```
...
docker run -it --rm --name spfx-helloworld -v /c/projects/spfx-helloworld:/usr/app/spfx -p 5432:5432 -p 4321:4321 -p 35729:35729 stfbauer/pnpspfx
```
